  ...
  }) /* end of prelude */(
    {
        ...
        utf8.read = function utf8_read(buffer, start, end) {
          ...
          while (start < end) {
            ...
            if (t < 128) {
              ...
              chunk[i++] = (t & 15) << 12 | (buffer[start++] & 63) << 6 |
                buffer[start++] & 63;
            }
            if (i > 8191) {
              (parts || (parts = [])).push(
          ...
          if (field.resolvedType) {
            if (field.resolvedType instanceof Enum) {
              ...
              for (
                ...
                if (
                  field.repeated && values[keys[i]] === field.typeDefault
                ) gen("default:");
        ...
        converter.toObject = function toObject(mtype) {
          ...
          if (mapFields.length) {
            ...
            for (i = 0; i < mapFields.length; ++i) {
              gen(
                "d%s={}",
                util.safeProp(mapFields[i].name),
              );
            }
            gen("}");
          }
          ...
          for (i = 0; i < fields.length; ++i) {
            ...
            if (field.map) {
              ...
              gen("if(m%s&&(ks2=Object.keys(m%s)).length){", prop, prop)(
                "d%s={}",
                prop,
          ...
          for (; i < /* initializes */ mtype.fieldsArray.length; ++i) {
            ...
            if (field.map) {
              ...
              gen("while(r.pos<c2){")("var tag2=r.uint32()")(
                "switch(tag2>>>3){",
              )("case 1: k=r.%s(); break", field.keyType)("case 2:");
      ...
      14: [function (require, module, exports) {
        ...
        function encoder(mtype) {
          ...
          var fields = /* initializes */ mtype.fieldsArray.slice().sort(
        ...
        Field.prototype.resolve = function resolve() {
          ...
          if ((this.typeDefault = types.defaults[this.type]) === undefined) { // if not a basic type, resolve it
            ...
            if (this.resolvedType instanceof Type) {
              ...
              this.typeDefault = this.resolvedType
                .values[Object.keys(this.resolvedType.values)[0]]; // first defined
            }
          }
          ...
          if (this.options) {
            if (
              ...
              this.options.packed !== undefined && this.resolvedType &&
                !(this.resolvedType instanceof Enum)
            ) {
        ...
        Namespace.isReservedId = function isReservedId(reserved, id) {
          if (reserved) {
            for (var i = 0; i < reserved.length; ++i) {
              if (
                typeof reserved[i] !== "string" && reserved[i][0] <= id &&
                reserved[i][1] > id
              ) {
                return true;
              }
        ...
        Namespace.prototype.add = function add(object) {
          if (
            !(object instanceof Field && object.extend !== undefined ||
              object instanceof Type || object instanceof Enum ||
              object instanceof Service || object instanceof Namespace)
          ) {
          ...
          if (!this.nested) {
            ...
            if (prev) {
              if (
                prev instanceof Namespace && object instanceof Namespace &&
      ...
      26: [function (require, module, exports) {
        ...
        function parse(source, root, options) {
          ...
          function illegal(token, name, insideTryCatch) {
            ...
            return Error(
              "illegal " + (name || "token") + " '" + token + "' (" +
                (filename ? filename + ", " : "") + "line " + tn.line + ")",
            );
          }
          ...
          function readRanges(target, acceptStrings) {
            ...
            do {
              if (
                acceptStrings && ((token = peek()) === '"' || token === "'")
              ) {
      ...
      27: [function (require, module, exports) {
        ...
        function indexOutOfRange(reader, writeLength) {
          return RangeError(
            "index out of range: " + reader.pos + " + " + (writeLength || 1) +
              " > " + reader.len,
          );
        }
        ...
        function readLongVarint() {
          ...
          if (this.len - this.pos > 4) { // fast route (hi)
            for (; i < 5; ++i) {
              // 6th..10th
              bits.hi = (bits.hi | (this.buf[this.pos] & 127) << i * 7 + 3) >>>
                0;
              if (this.buf[this.pos++] < 128) {
                return bits;
              }
      ...
      29: [function (require, module, exports) {
              ...
              if (!util.isString(source)) {
                ...
                if (parsed.imports) {
                  for (; i < parsed.imports.length; ++i) {
                    if (
                      resolved = getBundledFileName(parsed.imports[i]) ||
                ...
                if (parsed.weakImports) {
                  for (i = 0; i < parsed.weakImports.length; ++i) {
                    if (
                      resolved = getBundledFileName(parsed.weakImports[i]) ||
        ...
        Root.prototype.resolveAll = function resolveAll() {
          if (this.deferred.length) {
            throw Error(
              "unresolvable extensions: " + this.deferred.map(function (field) {
                return "'extend " + field.extend + "' in " +
        ...
        Root.prototype._handleAdd = function _handleAdd(object) {
          if (object instanceof Field) {
            if (
              /* an extension field (implies not part of a oneof) */ object
                    .extend !== undefined && /* not already handled */
            ...
            /* everything else is a namespace */ if (object instanceof Type) { // Try to handle any deferred extensions
      ...
      33: [function (require, module, exports) {
        ...
        Service.prototype.create = function create(
          ...
          for (
            ...
            var methodName = util.lcFirst(
              (method = this._methodsArray[i]).resolve().name,
            ).replace(/[^$\w_]/g, "");
        ...
        function tokenize(source, alternateCommentMode) {
          ...
          function cmnt(trailingLine) {
            ...
            if (trailingLine === undefined) {
              ...
              if (
                commentLine === trailingLine && !commentLineEmpty &&
                (alternateCommentMode || commentType === "/")
              ) {
     ...
     */
        ...
        Object.defineProperties(Type.prototype, {
          ...
          ctor: {
            get: function () {
              return this._ctor ||
                (this.ctor = Type.generateConstructor(this)());
            },
            set: function (ctor) {
      ...
      37: [function (require, module, exports) {
        ...
        util.safeProp = function safeProp(prop) {
          if (!/^[$\w_]+$/.test(prop) || util.isReserved(prop)) {
            return '["' +
              prop.replace(safePropBackslashRe, "\\\\").replace(
                safePropQuoteRe,
                '\\"',
              ) + '"]';
          }
        ...
        Object.defineProperty(util, "decorateRoot", {
          get: function () {
            return roots["decorated"] ||
              (roots["decorated"] = new (require(29))());
          },
        });
      }, {
        "15": 15,
      ...
      38: [function (require, module, exports) {
        ...
        LongBits.prototype.length = function length() {
          ...
          return part2 === 0
            ? part1 === 0
              ? part0 < 16384 ? part0 < 128 ? 1 : 2 : part0 < 2097152 ? 3 : 4
              : part1 < 16384
              ? part1 < 128 ? 5 : 6
              : part1 < 2097152
              ? 7
      ...
      39: [function (require, module, exports) {
         ...
         */
        util.Array = typeof Uint8Array !== "undefined"
        ...
        function verifier(mtype) {
          ...
          for (var i = 0; i < /* initializes */ mtype.fieldsArray.length; ++i) {
            ...
            if (field.map) {
              ...
              )("var k=Object.keys(%s)", ref)("for(var i=0;i<k.length;++i){");
      ...
      43: [function (require, module, exports) {
        ...
        BufferWriter._configure = function () {
          ...
          BufferWriter.writeBytesBuffer =
            util.Buffer && util.Buffer.prototype instanceof Uint8Array &&
